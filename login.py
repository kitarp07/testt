...
class Login:
    def __init__(self, master):
        ...
        # Button
        btn_login = Button(Frame_login, text="Login", font=("Roboto", 12), fg="#6162FF", bg="white",
                           command=self.login).place(x=20, y=270)
        btn_register = Button(Frame_login, text="Register", font=("Roboto", 12), fg="#6162FF", bg="white",
                              command=self.new_window).place(x=100, y=270)
...
class Register:
    def __init__(self, master):
        ...
        # Button
        btn_register = Button(Frame_login, text="Register", font=("Roboto", 12), fg="#6162FF", bg="white",
                              command=self.register).place(x=20, y=270)
        btn_back = Button(Frame_login, text="Back", font=("Roboto", 12), fg="#6162FF", bg="white",
                          command=self.back).place(x=100, y=270)
    ...
    def register(self):
        ...
        if row:
            ...
            messagebox.showinfo('info', "Registration Failed")
